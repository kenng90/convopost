...
class Media extends Node
{
    public function process($message, $data)
    {
        ...
        try {
            ...
            $contact->sendMessage($mediaUrl, false, false, $messageType, null, null, null, true);

            //Send the message
            $contact->sendMessage($contact->changeVariables($message), false, false, 'TEXT', null, null, null, true);
