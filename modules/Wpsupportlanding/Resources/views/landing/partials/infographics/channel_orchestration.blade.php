...
<div class="infographic-panel relative overflow-hidden rounded-3xl border border-gray-200 p-6 sm:p-8" style="background:linear-gradient(180deg,#FFF8EC 0%,#ffffff 100%);">
  <div class="flex flex-col lg:flex-row gap-8 items-center">
    <div class="lg:w-2/5">
      <p class="text-[11px] font-semibold uppercase tracking-[0.18em] mb-2" style="color:#28B463;">Channel orchestration</p>
      ...
      <ul class="space-y-2 text-base text-gray-600">
        ...
        <li class="flex gap-2"><span style="color:#28B463;">→</span> MauzoChat SMS with optional Sender ID</li>
        <li class="flex gap-2"><span style="color:#28B463;">→</span> Transparent rates from KES 0.6 per SMS</li>
        <li class="flex gap-2"><span style="color:#28B463;">→</span> Timezone-aware scheduling</li>
        <li class="flex gap-2"><span style="color:#28B463;">→</span> Pause, resume, and API-triggered sends</li>
      </ul>
    </div>
      ...
      <svg viewBox="0 0 520 280" class="w-full h-auto" role="img" aria-label="Campaign engine broadcasting to WhatsApp, SMS, and email">
        <defs>
          <linearGradient id="chBeam" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stop-color="#28B463" stop-opacity="0.1"/>
            <stop offset="100%" stop-color="#28B463" stop-opacity="0.6"/>
          </linearGradient>
        </defs>

        {{-- Source --}}
        <rect x="20" y="100" width="140" height="80" rx="16" fill="#ffffff" stroke="#28B463" stroke-width="1.75"/>
        <text x="90" y="132" text-anchor="middle" fill="#28B463" font-size="10" font-weight="700" font-family="Outfit,Plus Jakarta Sans,sans-serif">CAMPAIGN</text>
        ...
        {{-- Channels --}}
        <g>
          <rect x="320" y="30" width="170" height="60" rx="14" fill="#ffffff" stroke="rgba(40,180,99,0.35)" stroke-width="1.5"/>
        ...
        <g>
          <rect x="320" y="110" width="170" height="60" rx="14" fill="#ffffff" stroke="rgba(40,180,99,0.35)" stroke-width="1.5"/>
        ...
        <g>
          <rect x="320" y="190" width="170" height="60" rx="14" fill="#ffffff" stroke="rgba(40,180,99,0.35)" stroke-width="1.5"/>
