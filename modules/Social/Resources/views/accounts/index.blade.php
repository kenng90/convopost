        ...
        <div class="header-body">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <p class="mb-0 text-white opacity-8">{{ __('Connect Facebook Pages, Instagram, LinkedIn, TikTok, YouTube, Threads, Pinterest, and Google Business Profile to publish from Unganisha Social.') }}</p>
                </div>
                <div class="col-auto">
