    ...
    'real_estate_agency_bot' => [
        ...
        'flow_data' => FaqConversationLoop::mergeInto([
            'nodes' => [
                [
                    ...
                    'data' => [
                        ...
                        'keywords' => [
                            ...
                            ['id' => 'kw3', 'value' => 'help', 'matchType' => 'exact'],
                            ['id' => 'kw4', 'value' => 'agent', 'matchType' => 'exact'],
                            ['id' => 'kw5', 'value' => 'listings', 'matchType' => 'contains'],
                        ],
                    ],
                ],
                [
                        ...
                        'settings' => [
                            ...
                            'sections' => [
                                ...
                                [
                                    ...
                                    'title' => 'Support',
                                    'rows' => [
                                        ['id' => 'row1', 'title' => 'Talk to an agent', 'description' => 'Speak with our team'],
                                    ],
                                ],
                            ],
                        ],
                ...
                [
                    ...
                    'data' => [
                        ...
                        'type' => 'message',
                        'settings' => [
                            'message' => 'Great — you are looking at *apartments for sale*. An assistant will help qualify your search next.',
                        ],
                    ],
                ],
                [
                    ...
                    'data' => [
                        ...
                        'type' => 'message',
                        'settings' => [
                            'message' => 'Great — you are looking at *houses for sale*. An assistant will help qualify your search next. Reply *video* anytime for a sample walkthrough.',
                        ],
                    ],
                ],
                [
                ...
                [
                    ...
                    'data' => [
                        ...
                        'type' => 'message',
                        'settings' => [
                            'message' => 'That walkthrough is unavailable right now. You can continue with an advisor or return to the property menu.',
                        ],
                    ],
                ],
                [
                ...
                [
                    ...
                    'data' => [
                        ...
                        'type' => 'message',
                        'settings' => [
                            'message' => 'Your request has been received. An agent will contact you here shortly. Reply *help* anytime for the property menu.',
                        ],
                    ],
                ],
                [
                ...
                [
                    ...
                    'data' => [
                        ...
                        'settings' => [
                            ...
                            'footer' => 'Reply *help* for the main menu.',
                ...
                [
                    ...
                    'data' => [
                        'label' => 'Rental inquiry received',
                        'type' => 'message',
                        'settings' => [
                            'message' => 'Thanks! We received your interest in {{listing_booking_item_title}} for {{listing_booking_preferred_datetime}}. An agent will follow up shortly. Reply *help* for the menu.',
                        ],
                    ],
                ],
                [
                ...
                [
                    ...
                    'data' => [
                        ...
                        'type' => 'message',
                        'settings' => [
                            'message' => 'Hope that helped! Reply *buy* or *rent* for listings, or *agent* to speak with an advisor.',
                        ],
                    ],
                ],
                [
                ...
                [
                    ...
                    'data' => [
                        ...
                        'type' => 'message',
                        'settings' => [
                            'message' => 'Thank you for your commercial property inquiry. A specialist will contact you within 24 hours. Reply *help* for the menu or *agent* for faster help.',
                        ],
                    ],
                ],
                [
            ...
            'edges' => [
                ...
                ['id' => 'e-listings-kw', 'source' => 'keyword_trigger-1', 'target' => 'listing_inquiry-1', 'sourceHandle' => 'keyword-kw5'],
                ['id' => 'e-apt-msg', 'source' => 'list_message-1', 'target' => 'message-buy-apartments', 'sourceHandle' => 'section1-row1'],
                ['id' => 'e-houses-msg', 'source' => 'list_message-1', 'target' => 'message-buy-houses', 'sourceHandle' => 'section1-row2'],
                ...
                ['id' => 'e-1bed-listing', 'source' => 'list_message-1', 'target' => 'listing_inquiry-1', 'sourceHandle' => 'section2-row2'],
                ['id' => 'e-2bed-listing', 'source' => 'list_message-1', 'target' => 'listing_inquiry-1', 'sourceHandle' => 'section2-row3'],
                ['id' => 'e-menu-agent', 'source' => 'list_message-1', 'target' => 'assign_agent-1', 'sourceHandle' => 'section3-row1'],
                ...
                ['id' => 'e-listing-group', 'source' => 'message-listing-received', 'target' => 'assign_group-1'],
                ['id' => 'e-price-counter', 'source' => 'branch-1', 'target' => 'counter-1', 'sourceHandle' => 'condition-cond-price-true'],
                ['id' => 'e-branch-false-recovery', 'source' => 'branch-1', 'target' => 'message-limit', 'sourceHandle' => 'condition-cond-price-false'],
                ...
                ['id' => 'e-video-rec-rent', 'source' => 'quick_replies-video-recovery', 'target' => 'listing_inquiry-1', 'sourceHandle' => 'button-3'],
                ['id' => 'e-q-store', 'source' => 'question-1', 'target' => 'datastore-1'],
                ['id' => 'e-store-http', 'source' => 'datastore-1', 'target' => 'http-1'],
            ...
            'questionFollowup' => 'Anything else to add? Reply *done* when ready to schedule a viewing, *video* for a walkthrough, *help* for the menu, or *agent* to speak with an advisor now.',
