...
<head>
    ...
    <title>Terms of Service — {{ config('app.name', 'ConvoConnect') }}</title>
    <meta name="description" content="Terms of Service for ConvoConnect, the social commerce platform for WhatsApp.">
    ...
    <section class="relative pt-28 pb-16 noise hero-glow min-h-screen">
        <div class="relative z-10 max-w-3xl mx-auto px-4 sm:px-6">
            <div class="mb-10">
                ...
                <h1 class="font-display text-4xl sm:text-5xl font-800 mb-3">Terms of Service</h1>
            ...
            <div class="mt-12 pt-8 border-t border-white/10 flex flex-wrap gap-4">
                ...
                @if (Route::has('policy.show'))
                    <a href="{{ route('policy.show') }}" class="text-sm text-gray-400 hover:text-white transition-colors">Privacy Policy</a>
                @endif
                @if (Route::has('login'))
