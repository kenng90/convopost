...
$env = [
    [
        ...
        'fields' => [
            ...
            ['title' => 'Offering mode', 'help' => 'social_commerce hides WhatsApp CRM UI (code retained). full re-enables inbox/campaigns after the non-compete window.', 'key' => 'OFFERING_MODE', 'value' => 'social_commerce', 'ftype' => 'select', 'data' => ['social_commerce' => 'Social commerce (WhatsApp dormant)', 'full' => 'Full platform (WhatsApp enabled)']],
