{{--
    campaign_file.blade.php
    Used exclusively by create_file.blade.php.
    Identical to the standard campaign partial except:
      - No group_id select (contacts come from the uploaded file)
      - Still renders campaign name, template picker, schedule inputs and Apply button
--}}
