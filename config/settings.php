...
[
    ...
    'pricing_enabled' => env('ENABLE_PRICING', false),
    ...
    'limit_items_name' => env('LIMIT_ITEMS_NAME', 'Campaigns per period'),
    'limit_views_name' => env('LIMIT_VIEWS_NAME', 'Messages per period'),
    'limit_orders_name' => env('LIMIT_ORDERS_NAME', 'Contacts stored'),
    'limit_items_show' => env('LIMIT_ITEMS_SHOW', true),
    'limit_views_show' => env('LIMIT_VIEWS_SHOW', true),
    'limit_orders_show' => env('LIMIT_ORDERS_SHOW', true),
    'enable_per_seat_billing' => env('ENABLE_PER_SEAT_BILLING', false),

    'privacy_policy' => env('PRIVACY_POLICY', null),
    'terms_of_service' => env('TERMS_OF_SERVICE', null),
