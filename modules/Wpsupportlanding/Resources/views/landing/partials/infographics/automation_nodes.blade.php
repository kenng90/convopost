...
<div class="infographic-panel relative overflow-hidden rounded-3xl border border-gray-200 p-6 sm:p-8" style="background:linear-gradient(180deg,#FFF8EC 0%,#ffffff 100%);">
  <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-6">
    <div>
      <p class="text-[11px] font-semibold uppercase tracking-[0.18em] mb-2" style="color:#0E8A7A;">Flowmaker</p>
  ...
  <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
    @foreach([
      ...
      <div class="rounded-2xl border border-gray-200 px-3 py-4 text-center hover:border-[rgba(14,138,122,0.35)] transition-colors" style="background:rgba(14,138,122,0.08);">
