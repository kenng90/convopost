        ...
        <div class="grid grid-cols-1 md:grid-cols-2 md:gap-24 md:bg-slate-200 gap-6 md:p-16 lg:p-20 md:overflow-hidden rounded-[3rem]">
            <div class="max-w-xl mx-auto text-left sm:text-center md:text-left flex justify-center flex-col">
                ...
                <div class="justify-start flex gap-3 flex-col mt-10 sm:flex-row w-full">
                    ...
                    @if (strlen(config('wpsupport.mobile_app_android_url',"#")) > 5)
                        <a href="{{ config('wpsupport.mobile_app_android_url',"#")}}" class="items-center justify-center focus:outline-none border-2 border-black text-white inline-flex bg-black duration-200 focus-visible:outline-black rounded-full focus-visible:ring-black hover:text-black hover:bg-transparent lg:w-auto px-6 py-2.5 text-center w-full" href="#">
                            <span class="">{{ __('Google Play')}}</span>
                        </a>   
                    @endif
                   
                    @if (strlen(config('wpsupport.mobile_app_ios_url',"#")) > 5)
                        <a href="{{ config('wpsupport.mobile_app_ios_url',"#")}}" class="items-center justify-center focus:outline-none border-2 border-black text-white inline-flex bg-black duration-200 focus-visible:outline-black rounded-full focus-visible:ring-black hover:text-black hover:bg-transparent lg:w-auto px-6 py-2.5 text-center w-full" href="#">
            ...
            <div class="relative order-last block md:max-w-full max-w-sm mx-auto w-full mt-6 md:mt-0 lg:h-[25rem]">
                <img alt="Phone Mockup" class="relative z-20" src="/default/wpbox/app.png">
