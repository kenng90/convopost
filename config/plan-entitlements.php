...
return [
    ...
    */
    'tiers' => [
        'starter' => [
            ...
            'features' => 'Shared team inbox, Up to 3 agents, 500 contacts, 1,000 messages/mo, Visual flow builder, Contact CRM',
            'limit_items' => 0,
            'limit_views' => 1000,
            'limit_orders' => 500,
        ...
        'pro' => [
            ...
            'features' => 'Everything in Growth, WhatsApp Flows, Voice calling, Journey pipelines, M-Pesa & Stripe, Reminders, Knowledge base, 15 agents, API access',
            'limit_items' => 0,
            'limit_views' => 0,
            'limit_orders' => 0,
            'limit_catalog_items' => 0,
        ...
        'agency' => [
            ...
            'features' => 'Everything in Pro, Unlimited agents & numbers, Cross-client operations, Full REST API, Priority support',
            'limit_items' => 0,
            'limit_views' => 0,
            'limit_orders' => 0,
            'limit_catalog_items' => 0,
    ...
    */
    'capability_labels' => [
        ...
        'reminders' => 'Reminders & reservations',
