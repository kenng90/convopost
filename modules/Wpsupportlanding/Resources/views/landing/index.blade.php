...
@php
  ...
  $metaTitle = \Modules\Wpsupportlanding\Support\ChatDukaBrand::metaTitle();
  $metaDescription = \Modules\Wpsupportlanding\Support\ChatDukaBrand::description();
  $registrationEnabled = !config('settings.disable_registration_page', false);
  $ogImage = \Modules\Wpsupportlanding\Support\ChatDukaBrand::ogImageUrl();
@endphp
...
@include('layouts.seo-schema', ['schemaSiteName' => $siteName, 'schemaDescription' => $metaDescription, 'schemaLogo' => url('/landing/chatduka/android-chrome-192x192.png')])
</head>


<body class="bg-[#FBF6EE] text-gray-900" x-data="{ mobileOpen: false, productOpen: false, mobileProductOpen: false, billing: 'monthly', faqOpen: null }" @keydown.escape.window="productOpen = false; mobileOpen = false">

<a href="#main-content" class="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:rounded-lg focus:text-black focus:font-semibold" style="background:#E8A317;">Skip to content</a>
...
<nav class="navbar-blur fixed top-0 left-0 right-0 z-50" style="height:72px;" @click.outside="productOpen = false">
  <div class="max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6 flex items-center justify-between h-full">
    ...
    <div class="hidden lg:flex items-center gap-6">
      <div class="relative">
        <button
          type="button"
          class="inline-flex items-center gap-1.5 text-[15px] text-white/75 hover:text-white transition-colors"
        ...
        <div
          ...
          style="box-shadow:0 18px 50px rgba(30,42,90,0.12);"
        >
      ...
      <a href="/blog" class="text-[15px] text-white/75 hover:text-white transition-colors">Blog</a>
      @endif
    </div>
    ...
    <div class="hidden lg:flex items-center gap-3">
      ...
      <a href="{{ route('register') }}" class="text-base font-semibold px-5 py-2.5 rounded-lg text-black transition-all hover:opacity-90 hover:scale-105" style="background:#E8A317;">Get Started Free</a>
      @endif
    </div>

    <!-- Mobile toggle -->
    <button type="button" class="lg:hidden text-white/80 hover:text-white" @click="mobileOpen = !mobileOpen; productOpen = false" :aria-expanded="mobileOpen.toString()" aria-controls="mobile-menu" aria-label="Toggle navigation menu">
  ...
  <div id="mobile-menu" x-show="mobileOpen" x-cloak class="lg:hidden border-t border-gray-200 px-4 py-4 space-y-1 max-h-[calc(100svh-72px)] overflow-y-auto" style="background:rgba(255,255,255,0.98);">
    ...
    <div class="pt-3 flex flex-col gap-2">
      ...
      @if($registrationEnabled)
      <a href="{{ route('register') }}" class="text-center py-2.5 text-sm font-semibold text-black rounded-lg" style="background:#E8A317;">Get Started Free</a>
      @endif
    </div>
  </div>
</nav>
...
<section class="relative min-h-[100svh] flex items-center pt-28 pb-16 overflow-hidden noise">
  <div class="absolute inset-0 z-0">
    <div class="absolute inset-0" style="background:
      radial-gradient(ellipse 70% 55% at 78% 42%, rgba(232,163,23,0.16) 0%, transparent 58%),
      radial-gradient(ellipse 50% 40% at 12% 70%, rgba(196,92,38,0.10) 0%, transparent 55%),
      linear-gradient(180deg, #F7EEDC 0%, #FBF6EE 50%, #ffffff 100%);"></div>
  ...
  <div class="relative z-10 max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6 w-full">
    <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
      {{-- Copy --}}
      <div class="max-w-2xl">
        <p class="section-label mb-3">{{ \Modules\Wpsupportlanding\Support\ChatDukaBrand::tagline() }}</p>
        <p class="font-display hero-brand font-800 text-ink mb-4">Chat<span style="color:#E8A317;">Duka</span></p>
        ...
        <div class="flex flex-wrap gap-3">
          @if($registrationEnabled)
          <a href="{{ route('register') }}" class="inline-flex items-center gap-2 px-7 py-4 text-base font-semibold text-black rounded-xl transition-all hover:opacity-90" style="background:#E8A317;">
            Start Free Today
          ...
          @else
          <a href="{{ route('login') }}" class="inline-flex items-center gap-2 px-7 py-4 text-base font-semibold text-black rounded-xl transition-all hover:opacity-90" style="background:#E8A317;">
            Sign In
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
          </a>
          @endif
        ...
        <p class="mt-6 text-sm text-gray-500">
          ...
          <a href="{{ route('services.automation') }}" class="group inline-flex items-center gap-1.5 ml-1 font-semibold text-gray-800 transition-colors hover:text-[#1E2A5A]">
            <span class="border-b border-dashed border-gray-400 group-hover:border-[#1E2A5A] transition-colors">I want to automate processes across my business</span>
      ...
      <div class="relative flex justify-center lg:justify-end">
        <div class="absolute -inset-8 rounded-full blur-3xl opacity-40 pointer-events-none" style="background:radial-gradient(circle,rgba(232,163,23,0.35),transparent 70%);"></div>
        <div class="phone-frame hero-phone overflow-hidden float relative z-10" style="background:#f4f6f8;">
          ...
          <div class="px-3 pt-2 pb-2.5" style="background:#1E2A5A;">
...
<section id="channels" class="py-24 border-b border-gray-200 bg-white">
  <div class="max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6">
    ...
    <div class="grid md:grid-cols-3 gap-5 mb-10">
      <div class="rounded-3xl border border-gray-200 p-7" style="background:linear-gradient(180deg,rgba(232,163,23,0.08),transparent);">
        ...
        <ul class="space-y-2 text-sm text-gray-700">
          <li class="flex gap-2"><span style="color:#E8A317;">✓</span> Embedded Signup onboarding</li>
          <li class="flex gap-2"><span style="color:#E8A317;">✓</span> Templates, lists, media &amp; payments</li>
          <li class="flex gap-2"><span style="color:#E8A317;">✓</span> Omni flow templates for bots</li>
        </ul>
      </div>
  ...
  <div class="relative z-10 max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6">
    ...
    <div class="grid md:grid-cols-3 gap-5 mb-12">
      <div class="rounded-3xl border border-gray-200 bg-white p-7 card-lift">
        <p class="text-[11px] font-semibold uppercase tracking-[0.16em] mb-3" style="color:#E8A317;">WhatsApp campaigns</p>
        ...
        <ul class="space-y-2 text-sm text-gray-700">
          <li class="flex gap-2"><span style="color:#E8A317;">→</span> Template &amp; session messaging</li>
          <li class="flex gap-2"><span style="color:#E8A317;">→</span> File, group &amp; quick audiences</li>
          <li class="flex gap-2"><span style="color:#E8A317;">→</span> Stage-triggered journey sends</li>
        </ul>
      </div>
      <div class="rounded-3xl border border-gray-200 bg-white p-7 card-lift">
        <p class="text-[11px] font-semibold uppercase tracking-[0.16em] mb-3" style="color:#C45C26;">SMS campaigns</p>
        <h3 class="font-display text-2xl font-800 text-gray-900 mb-3">SMS</h3>
        <p class="text-base text-gray-600 leading-relaxed mb-5">ChatDuka SMS with optional Sender ID — reach customers who prefer text, at transparent rates.</p>
        <ul class="space-y-2 text-sm text-gray-700">
          <li class="flex gap-2"><span style="color:#C45C26;">→</span> ChatDuka SMS · Sender ID</li>
          <li class="flex gap-2"><span style="color:#C45C26;">→</span> From KES 0.6 per SMS</li>
          <li class="flex gap-2"><span style="color:#C45C26;">→</span> Same campaign engine &amp; audiences</li>
        </ul>
      </div>
      <div class="rounded-3xl border border-gray-200 bg-white p-7 card-lift">
...
<section class="py-24 border-b border-gray-200">
  <div class="max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6">
    ...
    <div class="grid lg:grid-cols-3 gap-6">
      <div class="rounded-3xl border border-gray-200 p-8" style="background:linear-gradient(180deg,rgba(232,163,23,0.06),transparent);">
        ...
        <ul class="space-y-2.5 text-base text-gray-700">
          <li class="flex gap-2"><span style="color:#E8A317;">·</span> Product Catalog & Shop</li>
          <li class="flex gap-2"><span style="color:#E8A317;">·</span> Invoices & Collections</li>
          <li class="flex gap-2"><span style="color:#E8A317;">·</span> Shopify & WooCommerce sync</li>
          <li class="flex gap-2"><span style="color:#E8A317;">·</span> Bookings & events</li>
        </ul>
      </div>
      <div class="rounded-3xl border border-gray-200 p-8" style="background:#ffffff;">
        ...
        <ul class="space-y-2.5 text-base text-gray-700">
          <li class="flex gap-2"><span style="color:#E8A317;">·</span> Omnichannel Team Inbox</li>
          <li class="flex gap-2"><span style="color:#E8A317;">·</span> Journey Pipelines</li>
          <li class="flex gap-2"><span style="color:#E8A317;">·</span> WhatsApp Calling</li>
          <li class="flex gap-2"><span style="color:#E8A317;">·</span> Agent Copilot</li>
        </ul>
      </div>
      <div class="rounded-3xl border border-gray-200 p-8" style="background:#ffffff;">
        ...
        <ul class="space-y-2.5 text-base text-gray-700">
          <li class="flex gap-2"><span style="color:#E8A317;">·</span> WhatsApp · SMS · Email campaigns</li>
          <li class="flex gap-2"><span style="color:#E8A317;">·</span> WhatsApp Flows</li>
          <li class="flex gap-2"><span style="color:#E8A317;">·</span> Omni Flow Automation</li>
          <li class="flex gap-2"><span style="color:#E8A317;">·</span> Developer APIs</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="relative z-10 max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <div class="card-lift bg-white border border-gray-200 rounded-2xl p-6">
        <div class="w-10 h-10 rounded-xl flex items-center justify-center mb-4 text-xl" style="background:rgba(232,163,23,0.1);">👥</div>
        ...
        <ul class="space-y-2">
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>WhatsApp · Instagram · Messenger</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Customer 360 unified sidebar</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Knowledge-based Copilot suggestions</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Chat assignment &amp; agent handover</li>
        </ul>
      </div>
      <!-- Card 2 -->
      <!-- <div class="card-lift bg-white border border-gray-200 rounded-2xl p-6">
        ...
        <p class="text-base text-gray-600 mb-4 leading-relaxed">One campaign engine for WhatsApp templates, ChatDuka SMS, and SMTP email — file upload, contact groups, or quick lists — with delivery analytics and timezone-aware scheduling.</p>
        <ul class="space-y-2">
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>WhatsApp, SMS &amp; email channels</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>ChatDuka SMS · Sender ID · KES 0.6 / SMS</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>File, group &amp; quick audiences</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Segments, scheduling &amp; analytics</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>API-triggered campaign sends</li>
        </ul>
      </div> -->
      <!-- Card 3 -->
      <div class="card-lift bg-white border border-gray-200 rounded-2xl p-6">
        <div class="w-10 h-10 rounded-xl flex items-center justify-center mb-4 text-xl" style="background:rgba(232,163,23,0.1);">🗂️</div>
        ...
        <ul class="space-y-2">
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>7 templates: sales, support, revenue & more</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Stage-triggered WhatsApp campaigns</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Auto-enroll new contacts & group rules</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Journey sidebar in chat</li>
        </ul>
      </div>
      <!-- Card 4 -->
      <div class="card-lift bg-white border border-gray-200 rounded-2xl p-6">
        ...
        <ul class="space-y-2">
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Flow template library (payments, booking, support)</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>AI Flow Assistant — natural language to draft</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Visual no-code flow builder</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>38+ nodes: forms, bookings, payments &amp; AI</li>
        </ul>
      </div>
      <!-- Card 5 -->
      <div class="card-lift border rounded-2xl p-6 relative overflow-hidden" style="background:rgba(232,163,23,0.04);border-color:rgba(232,163,23,0.2);">
        <div class="absolute top-3 right-3 badge text-xs">New</div>
        <div class="w-10 h-10 rounded-xl flex items-center justify-center mb-4 text-xl" style="background:rgba(232,163,23,0.15);">📋</div>
        ...
        <ul class="space-y-2">
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Drag-and-drop form builder</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>One-click publish to Meta</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Convert responses into automations</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Booking &amp; commerce data exchange</li>
        </ul>
      </div>
      <!-- Card 6 -->
      <div class="card-lift bg-white border border-gray-200 rounded-2xl p-6">
        ...
        <ul class="space-y-2">
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Inbound &amp; outbound WhatsApp calls</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>AI voice context &amp; booking handoff</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Call analytics dashboard</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Agent performance reports</li>
        </ul>
      </div>
      <!-- Card 7 -->
      <div class="card-lift bg-white border border-gray-200 rounded-2xl p-6">
        ...
        <ul class="space-y-2">
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Public invoice &amp; payment links</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>M-Pesa STK retry when PIN times out</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Paystack fallback + WhatsApp chase</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Collections board for open invoices</li>
        </ul>
      </div>
      <!-- Card 8 -->
      <div class="card-lift border rounded-2xl p-6 relative overflow-hidden" style="background:rgba(232,163,23,0.04);border-color:rgba(232,163,23,0.2);">
        ...
        <ul class="space-y-2">
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Multi-staff & department scheduling</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Embeddable booking widgets & events</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Google Calendar sync</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>WhatsApp reminder campaigns</li>
        </ul>
      </div>
      <!-- Card 9 -->
      <div class="card-lift border rounded-2xl p-6 relative overflow-hidden" style="background:rgba(232,163,23,0.04);border-color:rgba(232,163,23,0.2);">
        <div class="absolute top-3 right-3 badge text-xs">Updated</div>
        <div class="w-10 h-10 rounded-xl flex items-center justify-center mb-4 text-xl" style="background:rgba(232,163,23,0.15);">🛍️</div>
        ...
        <ul class="space-y-2">
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Branded shop links & in-chat selling</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Store sync & inventory tracking</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Checkout via WhatsApp or invoice</li>
          <li class="flex items-start gap-2 text-base text-gray-600"><span style="color:#E8A317;" class="mt-0.5 flex-shrink-0">✓</span>Catalog analytics & A/B tests</li>
        </ul>
      </div>
    </div>
  </div>
...
<section id="platform" class="py-24 border-y border-gray-200 relative overflow-hidden" style="background:#FFF8EC;">
  ...
  <div class="relative z-10 max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6">
    <div class="text-center mb-16">
      ...
      <p class="body-lg text-gray-600 max-w-3xl mx-auto">From guided activation to revenue dashboards and proactive health alerts — ChatDuka helps you launch quickly and stay on top of what matters.</p>
    </div>

    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
      <div class="card-lift bg-white border border-gray-200 rounded-2xl p-6">
        <div class="w-10 h-10 rounded-xl flex items-center justify-center text-xl mb-4" style="background:rgba(232,163,23,0.1);">🚀</div>
...
<section class="py-24 border-y border-gray-200" style="background:#FFF8EC;">
  <div class="max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6 grid lg:grid-cols-2 gap-16 items-center">
    <div>
      ...
      <p class="text-gray-600 leading-relaxed mb-8">WhatsApp Flows are interactive, multi-screen forms that open natively inside WhatsApp — no links, no browsers, no friction. ChatDuka gives you a drag-and-drop builder, one-click Meta publish, and a bridge into Flowmaker for bookings and commerce.</p>
      <ul class="space-y-4 mb-8">
        <li class="flex items-start gap-3">
          <div class="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5" style="background:rgba(232,163,23,0.15);">
            <svg class="w-3.5 h-3.5" style="color:#E8A317;" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>
          </div>
          <div>
      ...
      @if($registrationEnabled)
      <a href="{{ route('register') }}" class="inline-flex items-center gap-2 px-5 py-3 text-sm font-semibold text-black rounded-xl" style="background:#E8A317;">Build Your First Flow →</a>
      @endif
    </div>
      ...
      <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-2xl">
        ...
        <div class="flex items-center justify-between px-4 py-3 border-b border-white/[0.06]" style="background:#f8fbf9;">
          <div class="flex items-center gap-2">
            ...
            <div class="w-3 h-3 rounded-full opacity-70" style="background:#E8A317;"></div>
          </div>
        ...
        <div class="flex" style="min-height:320px;">
          ...
          <div class="w-36 border-r border-white/[0.06] px-3 py-3 space-y-1.5" style="background:#f8fbf9;">
            ...
            <div class="flex items-center gap-2 px-2 py-1.5 rounded-lg text-xs font-semibold cursor-pointer transition-colors" style="color:#E8A317;background:rgba(232,163,23,0.08);">
              <span>📸</span> Image
            </div>
          </div>
          <!-- Canvas -->
          <div class="flex-1 px-4 py-4 space-y-2.5">
            ...
            <!-- Form fields -->
            <div class="bg-[#FFF8EC] border border-gray-200 rounded-xl p-3 relative group cursor-pointer" style="border-left:3px solid #E8A317;">
            ...
            <div class="bg-[#f8fbf9] border border-gray-200 rounded-xl p-3 group cursor-pointer hover:border-gray-200 transition-colors">
              ...
              <div class="space-y-1">
                ...
                <div class="flex items-center gap-2"><div class="w-3 h-3 rounded-full border flex items-center justify-center" style="border-color:#E8A317;"><div class="w-1.5 h-1.5 rounded-full" style="background:#E8A317;"></div></div><p class="text-xs text-gray-300">11–50 employees</p></div>
            ...
            <!-- Submit -->
            <button class="w-full py-2 rounded-xl text-xs font-semibold text-black" style="background:#E8A317;">Submit Form →</button>
          </div>
        </div>
        <!-- Footer -->
        <div class="flex items-center justify-between px-4 py-2.5 border-t border-gray-200" style="background:#f8fbf9;">
          ...
          <div class="flex gap-2">
            ...
            <button class="text-xs px-3 py-1 rounded-lg text-black font-semibold" style="background:#E8A317;">Publish to Meta</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6">
    ...
    <div class="grid md:grid-cols-3 gap-4 mb-16">
      <div class="card-lift bg-white border border-gray-200 rounded-2xl p-6 text-center">
        <div class="w-12 h-12 rounded-2xl flex items-center justify-center text-2xl mx-auto mb-4" style="background:rgba(232,163,23,0.1);">📋</div>
      ...
      <div class="card-lift border rounded-2xl p-6 text-center" style="background:rgba(232,163,23,0.04);border-color:rgba(232,163,23,0.2);">
        <div class="w-12 h-12 rounded-2xl flex items-center justify-center text-2xl mx-auto mb-4" style="background:rgba(232,163,23,0.15);">🧭</div>
        <p class="font-display font-700 text-base mb-2" style="color:#E8A317;">2. Drag Contacts on Kanban</p>
      ...
      <div>
        ...
        <div class="space-y-4">
          <div class="flex items-start gap-4">
            <div class="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 text-base" style="background:rgba(232,163,23,0.1);">🎯</div>
            <div>
          ...
          <div class="flex items-start gap-4">
            <div class="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 text-base" style="background:rgba(232,163,23,0.1);">⚙️</div>
            <div>
        ...
        @if($registrationEnabled)
        <a href="{{ route('register') }}" class="inline-flex items-center gap-2 mt-8 px-5 py-3 text-sm font-semibold text-black rounded-xl" style="background:#E8A317;">Start Your First Journey →</a>
        @endif
      </div>
          ...
          <div class="px-4 py-4 grid grid-cols-4 gap-2">
            ...
            <div class="rounded-xl border border-gray-200 p-2" style="background:#ffffff;">
              ...
              <div class="space-y-1.5">
                ...
                <div class="rounded-lg px-2 py-1.5 border border-gray-200" style="background:#FFF8EC;">
...
<!-- ===== BOOKINGS SPOTLIGHT ===== -->
<!-- <section id="bookings" class="py-24 border-y border-gray-200" style="background:#FFF8EC;">
  <div class="max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6">
    <div class="text-center mb-16">
      ...
      <p class="body-lg text-gray-600 max-w-3xl mx-auto">The Bookings app inside ChatDuka — multi-staff scheduling, public widgets, event registrations, Google Calendar sync, and WhatsApp reminders. Configure everything from one Bookings tab in Company Apps.</p>
    </div>
    ...
    <div class="grid md:grid-cols-3 gap-4 mb-16">
      <div class="card-lift bg-white border border-gray-200 rounded-2xl p-6 text-center">
        <div class="w-12 h-12 rounded-2xl flex items-center justify-center text-2xl mx-auto mb-4" style="background:rgba(232,163,23,0.1);">⚙️</div>
      ...
      <div class="card-lift border rounded-2xl p-6 text-center" style="background:rgba(232,163,23,0.04);border-color:rgba(232,163,23,0.2);">
        <div class="w-12 h-12 rounded-2xl flex items-center justify-center text-2xl mx-auto mb-4" style="background:rgba(232,163,23,0.15);">🌐</div>
        <p class="font-display font-700 text-base mb-2" style="color:#E8A317;">2. Share Your Booking Page</p>
    ...
    <div class="grid lg:grid-cols-2 gap-12 items-center">
      <div>
        ...
        @if($registrationEnabled)
        <a href="{{ route('register') }}" class="inline-flex items-center gap-2 mt-8 px-5 py-3 text-sm font-semibold text-black rounded-xl" style="background:#E8A317;">Start Booking on WhatsApp →</a>
        @endif
      </div>
        ...
        <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-2xl">
          ...
          <div class="px-5 py-5 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-2">
              <div class="flow-node px-3 py-2.5 text-center" style="border-color:rgba(232,163,23,0.4);background:rgba(232,163,23,0.08);">
                <p class="text-xs font-semibold" style="color:#E8A317;">Premium Cut</p>
            ...
            <div>
              ...
              <div class="grid grid-cols-3 gap-2">
                ...
                <div class="flow-node px-2 py-1.5 text-center text-xs font-semibold" style="color:#E8A317;border-color:rgba(232,163,23,0.4);">14:00</div>
                <div class="flow-node px-2 py-1.5 text-center text-xs text-gray-500">16:30</div>
              </div>
            </div>
            <div class="flex items-center gap-3 px-3 py-2 rounded-xl" style="background:rgba(232,163,23,0.06);border:1px solid rgba(232,163,23,0.15);">
              <div class="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold" style="background:linear-gradient(135deg,#E8A317,#1E2A5A);">SM</div>
              <div>
                <p class="text-xs font-semibold text-gray-900">Sarah Mwangi</p>
                <p class="text-xs text-gray-500">Senior Stylist</p>
              </div>
            </div>
            <button class="w-full py-2.5 rounded-xl text-xs font-semibold text-black" style="background:#E8A317;">Confirm Booking →</button>
          </div>
          <div class="px-4 py-2.5 border-t border-gray-200 flex items-center justify-between" style="background:#f8fbf9;">
            <p class="text-xs text-gray-500">Powered by ChatDuka</p>
            <div class="flex gap-2">
...
<section id="catalog" class="py-24 border-y border-gray-200" style="background:#f0faf7;">
  <div class="max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6">
    ...
    <div class="grid md:grid-cols-3 gap-4 mb-16">
      ...
      <div class="card-lift border rounded-2xl p-6 text-center" style="background:rgba(232,163,23,0.04);border-color:rgba(232,163,23,0.2);">
        <div class="w-12 h-12 rounded-2xl flex items-center justify-center text-2xl mx-auto mb-4" style="background:rgba(232,163,23,0.15);">⚡</div>
        <p class="font-display font-700 text-base mb-2" style="color:#E8A317;">2. Sell from Chat or Flows</p>
      ...
      <div class="card-lift bg-white border border-gray-200 rounded-2xl p-6 text-center">
        ...
        <p class="text-base text-gray-600 leading-relaxed">Generate a PDF invoice in the same conversation. If STK times out, ChatDuka retries, offers Paystack, and chases on WhatsApp until the invoice is paid.</p>
      </div>
    </div>
    ...
    <div class="grid lg:grid-cols-2 gap-12 items-center">
      ...
      <div>
        ...
        @if($registrationEnabled)
        <a href="{{ route('register') }}" class="inline-flex items-center gap-2 mt-8 px-5 py-3 text-sm font-semibold text-black rounded-xl" style="background:#E8A317;">Start Selling on WhatsApp →</a>
        @endif
      </div>
      ...
      <div class="relative">
        <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-2xl">
          ...
          <div class="px-6 py-5 space-y-0 flex flex-col items-center">
            ...
            <div class="flow-node px-4 py-3 w-full text-center" style="border-color:rgba(232,163,23,0.3);">
              <div class="flex items-center gap-2 justify-center mb-0.5">
                <span class="text-base">🛒</span>
                <p class="text-xs font-semibold" style="color:#E8A317;">Product Catalog</p>
              </div>
            ...
            <div class="flow-line"></div>
            <div class="flow-node px-4 py-3 w-full text-center" style="background:rgba(232,163,23,0.08);border-color:rgba(232,163,23,0.3);">
              <div class="flex items-center gap-2 justify-center mb-0.5">
                <span class="text-base">✅</span>
                <p class="text-xs font-semibold" style="color:#E8A317;">Payment Confirmed</p>
              </div>
...
<section id="collections" class="py-24 border-y border-gray-200" style="background:#f7f4ff;">
  <div class="max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6">
    <div class="text-center mb-16">
      ...
      <p class="body-lg text-gray-600 max-w-3xl mx-auto">Conversation to catalog or booking to invoice to STK. If the PIN times out, ChatDuka retries on your Daraja keys, offers Paystack, then chases on WhatsApp. Money never sits in our wallet — settlement stays on your keys.</p>
    </div>
    ...
    <div class="grid md:grid-cols-3 gap-4 mb-16">
      ...
      <div class="card-lift border rounded-2xl p-6 text-center" style="background:rgba(232,163,23,0.04);border-color:rgba(232,163,23,0.2);">
        <div class="w-12 h-12 rounded-2xl flex items-center justify-center text-2xl mx-auto mb-4" style="background:rgba(232,163,23,0.15);">🔁</div>
        <p class="font-display font-700 text-base mb-2" style="color:#E8A317;">2. STK retry &amp; Paystack fallback</p>
    ...
    <div class="grid lg:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <div class="space-y-4">
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <p class="text-sm text-gray-600">ChatDuka orchestrates STK, retries, fallback, and chase. Settlement lands on the merchant account you already connected — we are not a PSP.</p>
            </div>
          </div>
          <div class="flex items-start gap-4">
            <div class="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 text-base" style="background:rgba(232,163,23,0.1);">📋</div>
        ...
        @if($registrationEnabled)
        <a href="{{ route('register') }}" class="inline-flex items-center gap-2 mt-8 px-5 py-3 text-sm font-semibold text-black rounded-xl" style="background:#E8A317;">Start collecting on WhatsApp →</a>
        @endif
      </div>
...
<section id="automation" class="py-24 relative overflow-hidden" style="background:#FFF8EC;">
  ...
  <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full h-px" style="background:linear-gradient(90deg,transparent,rgba(232,163,23,0.3),transparent);"></div>
  <div class="relative z-10 max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6">
    <div class="text-center mb-16">
    ...
    <div class="grid lg:grid-cols-2 gap-12 items-center">
      ...
      <div class="space-y-0">
        <div class="flex flex-col items-center">
          ...
          <div class="flow-line"></div>
          <div class="flow-node px-5 py-3 w-64 text-center" style="border-color:rgba(232,163,23,0.35);">
            <div class="flex items-center gap-2 justify-center mb-1">
              <span class="text-lg">📋</span>
              <p class="text-sm font-semibold" style="color:#E8A317;">WhatsApp Flow</p>
            </div>
      ...
      <div class="space-y-3">
        ...
        <div class="flow-node px-4 py-3.5 flex items-start gap-4">
          <div class="w-9 h-9 rounded-lg flex items-center justify-center text-lg flex-shrink-0" style="background:rgba(232,163,23,0.1);">⚡</div>
          <div>
        ...
        <div class="flow-node px-4 py-3.5 flex items-start gap-4">
          <div class="w-9 h-9 rounded-lg flex items-center justify-center text-lg flex-shrink-0" style="background:rgba(232,163,23,0.1);">🛍️</div>
          <div>
...
<section id="integrations" class="py-24 relative">
  <div class="max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6">
    <div class="text-center mb-16">
      ...
      <p class="body-lg text-gray-600 max-w-3xl mx-auto">Connect the tools that power selling and outreach — Meta Embedded Signup for WhatsApp, Instagram &amp; Messenger, store sync, commerce payments, ChatDuka SMS with Sender ID, email, and an embeddable WhatsApp widget.</p>
    </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-12">
      ...
      <div class="integration-card rounded-2xl p-5 flex flex-col items-center text-center gap-2.5">
        ...
        <div><p class="text-base font-semibold text-gray-900">ChatDuka SMS</p><p class="text-xs text-gray-500 mt-0.5">Sender ID · KES 0.6 / SMS</p></div>
      </div>
      <div class="integration-card rounded-2xl p-5 flex flex-col items-center text-center gap-2.5">
...
<section id="api" class="py-24 relative overflow-hidden" style="background:#F7EEDC;">
  ...
  <div class="absolute top-0 left-0 right-0 h-px" style="background:linear-gradient(90deg,transparent,rgba(232,163,23,0.2),transparent);"></div>
  <div class="relative z-10 max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6">
    <div class="text-center mb-16">
      ...
      <div class="space-y-2">
        ...
        <div class="space-y-2">
          ...
          <div class="flex items-center gap-3 px-4 py-3 rounded-xl bg-white border border-gray-200">
            <span class="text-xs font-mono font-bold px-2 py-0.5 rounded" style="background:rgba(232,163,23,0.15);color:#E8A317;">POST</span>
        ...
        <div class="pt-4 flex flex-wrap items-center gap-3">
          @if($registrationEnabled)
          <a href="{{ route('register') }}" class="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-semibold text-black rounded-xl" style="background:#E8A317;">Get Your API Key →</a>
          @endif
...
<span style="color:#dcdcaa;">console</span><span style="color:#d4d4d4;">.</span><span style="color:#dcdcaa;">log</span><span style="color:#d4d4d4;">(</span><span style="color:#9cdcfe;">data</span><span style="color:#d4d4d4;">);</span></code></pre>
        ...
        <div class="mt-4 flex items-center gap-3 p-3 rounded-xl" style="background:rgba(232,163,23,0.05);border:1px solid rgba(232,163,23,0.1);">
          <div class="w-2 h-2 rounded-full flex-shrink-0" style="background:#E8A317;"></div>
    ...
    <div class="grid gap-4 {{ $planCount === 1 ? 'max-w-sm mx-auto' : ($planCount === 2 ? 'md:grid-cols-2 max-w-2xl mx-auto' : 'md:grid-cols-3') }}">
      ...
      <div class="pricing-popular card-lift rounded-2xl p-7 relative">
        <div class="absolute -top-3 left-1/2 -translate-x-1/2">
          <span class="badge font-semibold" style="background:rgba(232,163,23,0.2);">Most Popular</span>
        </div>
        <div class="mb-6">
          <p class="text-sm mb-1 font-medium" style="color:#E8A317;">{{ $plan->name }}</p>
        ...
        @if($registrationEnabled)
        <a href="{{ route('register') }}" class="block w-full text-center py-2.5 rounded-xl text-sm font-semibold text-black transition-all hover:opacity-90 mb-6" style="background:#E8A317;">Get Started</a>
        @endif
        @if(count($features) > 0)
        <ul class="space-y-2.5">
          @foreach($features as $feature)
          <li class="flex items-center gap-2.5 text-base text-gray-700">
            <svg class="w-4 h-4 flex-shrink-0" style="color:#E8A317;" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
            {{ $feature }}
          </li>
          @endforeach
        </ul>
...
<!-- ===== TESTIMONIALS ===== -->
<!-- <section class="py-24 border-t border-gray-200" style="background:#FFF8EC;">
  <div class="max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6">
    <div class="text-center mb-16">
    ...
    <div class="grid md:grid-cols-3 gap-4">
      <div class="card-lift bg-white border border-gray-200 rounded-2xl p-6">
        ...
        <div class="flex items-center gap-3">
          <div class="w-9 h-9 rounded-full flex items-center justify-center font-semibold text-sm" style="background:linear-gradient(135deg,#E8A317,#1E2A5A);">AM</div>
    ...
    <div class="space-y-2">
      <div class="border border-gray-200 rounded-2xl overflow-hidden bg-white">
        <button type="button" class="w-full flex items-center justify-between px-6 py-4 text-left" @click="faqOpen = faqOpen === 1 ? null : 1" :aria-expanded="(faqOpen === 1).toString()" aria-controls="faq-panel-1" id="faq-button-1">
          <span class="text-lg font-semibold text-gray-900">Do I need a WhatsApp Business API account to use ChatDuka?</span>
        ...
        <div id="faq-panel-1" x-show="faqOpen === 1" x-cloak class="px-6 pb-4" role="region" aria-labelledby="faq-button-1">
          <p class="text-base text-gray-600 leading-relaxed">No — ChatDuka is built on the official Meta WhatsApp Business Cloud API. Our Activation OS walks you through Embedded Signup, team setup, and your first flow — most businesses send their first reply within 15 minutes.</p>
        </div>
      </div>
      <div class="border border-gray-200 rounded-2xl overflow-hidden bg-white">
      ...
      <div class="border border-gray-200 rounded-2xl overflow-hidden bg-white">
        ...
        <div id="faq-panel-5" x-show="faqOpen === 5" x-cloak class="px-6 pb-4" role="region" aria-labelledby="faq-button-5">
          <p class="text-base text-gray-600 leading-relaxed">Yes. Native M-Pesa STK push collects on your Daraja keys for Kenya and East Africa. If a PIN times out, ChatDuka retries STK, then offers Paystack as a fallback and chases unpaid invoices on WhatsApp. Paid status shows on the collections board and can resume automation flows. Money stays on your keys — ChatDuka is not a wallet or PSP. Stripe is used for ChatDuka SaaS subscriptions, not in-chat commerce checkout.</p>
        </div>
      </div>
      <div class="border border-gray-200 rounded-2xl overflow-hidden bg-white">
      ...
      <div class="border border-gray-200 rounded-2xl overflow-hidden bg-white">
        <button type="button" class="w-full flex items-center justify-between px-6 py-4 text-left" @click="faqOpen = faqOpen === 7 ? null : 7" :aria-expanded="(faqOpen === 7).toString()" aria-controls="faq-panel-7" id="faq-button-7">
          <span class="text-lg font-semibold text-gray-900">How is ChatDuka different from Meta's Business Agent?</span>
      ...
      <div class="border border-gray-200 rounded-2xl overflow-hidden bg-white">
        ...
        <div id="faq-panel-14" x-show="faqOpen === 14" x-cloak class="px-6 pb-4" role="region" aria-labelledby="faq-button-14">
          <p class="text-base text-gray-600 leading-relaxed">No. Collections is the engine around your existing invoices: M-Pesa STK retry when a PIN times out, Paystack fallback, WhatsApp chase, and a board of open invoices. Settlement stays on your Daraja and Paystack keys. ChatDuka is not a wallet, float, or PSP. Stripe is only for ChatDuka SaaS billing.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="py-24 relative overflow-hidden" style="background:#F7EEDC;">
  <div class="absolute inset-0" style="background:radial-gradient(ellipse 80% 60% at 50% 50%, rgba(232,163,23,0.15) 0%, transparent 70%);"></div>
  <div class="absolute top-0 left-0 right-0 h-px" style="background:linear-gradient(90deg,transparent,rgba(232,163,23,0.3),transparent);"></div>
  <div class="relative z-10 max-w-5xl mx-auto px-3 sm:px-4 lg:px-6 text-center">
    ...
    <div class="flex flex-wrap justify-center gap-4 mb-6">
      @if($registrationEnabled)
      <a href="{{ route('register') }}" class="inline-flex items-center gap-2 px-8 py-4 text-base font-semibold text-black rounded-xl transition-all hover:opacity-90 hover:scale-105" style="background:#E8A317;">
        Start Free Today
      ...
      @else
      <a href="{{ route('login') }}" class="inline-flex items-center gap-2 px-8 py-4 text-base font-semibold text-black rounded-xl transition-all hover:opacity-90 hover:scale-105" style="background:#E8A317;">
        Sign In
        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
      </a>
      @endif
...
<!-- ===== FOOTER ===== -->
<footer class="border-t border-gray-200 py-16" style="background:#151D40;">
  <div class="max-w-[90rem] mx-auto px-3 sm:px-4 lg:px-6">
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
      ...
      <div class="lg:col-span-2">
        ...
        <p class="text-base text-white/70 leading-relaxed max-w-xs mb-5">Your duka, in every chat — recover carts, convert bookings, collect unpaid invoices, and get paid on your M-Pesa or Paystack keys. Built on the official Meta WhatsApp Business API.</p>
      </div>
      <!-- Product -->
      <div>
        <p class="text-xs font-semibold uppercase tracking-wider text-white/50 mb-4">Product</p>
        <ul class="space-y-2.5">
          <li><a href="#features" class="text-[15px] text-white/70 hover:text-white transition-colors">Features</a></li>
          <li><a href="#journeys" class="text-sm text-white/70 hover:text-white transition-colors">Journeys</a></li>
          <li><a href="#bookings" class="text-sm text-white/70 hover:text-white transition-colors">Bookings</a></li>
          <li><a href="#catalog" class="text-sm text-white/70 hover:text-white transition-colors">Product Catalog</a></li>
          <li><a href="#collections" class="text-sm text-white/70 hover:text-white transition-colors">Collections</a></li>
          <li><a href="#automation" class="text-sm text-white/70 hover:text-white transition-colors">Automation</a></li>
          <li><a href="#integrations" class="text-sm text-white/70 hover:text-white transition-colors">Integrations</a></li>
          <li><a href="#api" class="text-sm text-white/70 hover:text-white transition-colors">API Docs</a></li>
          <li><a href="#pricing" class="text-sm text-white/70 hover:text-white transition-colors">Pricing</a></li>
        </ul>
      </div>
      <!-- Company -->
      <div>
        <p class="text-xs font-semibold uppercase tracking-wider text-white/50 mb-4">Company</p>
        <ul class="space-y-2.5">
          @if(isset($hasBlog) && $hasBlog)
          <li><a href="/blog" class="text-sm text-white/70 hover:text-white transition-colors">Blog</a></li>
          @endif
          <li><a href="{{ route('policy.show') }}" class="text-sm text-white/70 hover:text-white transition-colors">Privacy Policy</a></li>
          <li><a href="{{ route('terms.show') }}" class="text-sm text-white/70 hover:text-white transition-colors">Terms of Service</a></li>
          <li><a href="#faq" class="text-sm text-white/70 hover:text-white transition-colors">FAQ</a></li>
          <li><a href="#pricing" class="text-sm text-white/70 hover:text-white transition-colors">Pricing</a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
      ...
      <div class="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-white/10" style="background:rgba(232,163,23,0.08);">
