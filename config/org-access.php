...
return [
    ...
    */
    'protected_routes' => [
        ...
        'admin.convoconnect.index',
        'admin.convoconnect.show',
        'admin.convoconnect.provision',
        'admin.convoconnect.resume-provision',
        'admin.convoconnect.approve-sender',
        'admin.convoconnect.sync-credits',
        'admin.convoconnect.store-credentials',
        'admin.share',
        'admin.apps.company',
        'admin.backup.index',
