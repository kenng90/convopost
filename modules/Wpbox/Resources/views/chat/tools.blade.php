<div class="card-footer d-block">
    ...
    <div class="tab-content mb-0" id="chatTabsContent" >
        ...
        <div v-if="chatTab === 'quick-replies'" class="p-4 d-flex quick-replies-container border-radius-lg border">
            ...
            <b-button v-if="!mobileChat && (!activeChat.channel || activeChat.channel === 'whatsapp')" class="btn w-100 btn-outline btn-outline-default shadow-none bg-default" v-b-modal.modal-templates style="">
