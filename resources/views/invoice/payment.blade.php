...
<body>
    <div class="invoice-container">
        ...
        <div class="invoice-content">
            ...
            <div class="invoice-section">
                ...
                @if(isset($invoice['sent_at']) && $invoice['sent_at'])
                <div class="whatsapp-sent-badge">
    ...
    <script>
        // Use UUID for public access instead of ID
        ...
        function pollPaymentStatus(paymentId, attempts = 0) {
            ...
            setTimeout(() => {
                // Pass customer phone for authorization
                const statusUrl = `/api/invoice/${invoiceId}/payment/${paymentId}/status?customer_phone={{ urlencode($invoice['customer_phone']) }}`;
                fetch(statusUrl)
