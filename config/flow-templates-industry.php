...
return [
    ...
    'healthcare_clinic_bot' => [
        ...
        'category' => 'healthcare',
        'video_url' => null,
        'setup_hint' => 'Link your appointment WhatsApp Flow, lab results API, OpenRouter key, Results Team group, and Awaiting Review journey stage.',
        'flow_data' => [
            'nodes' => [
                [
                    ...
                    'data' => [
                        ...
                        'settings' => [
                            'llm' => [
                                ...
                                'systemPrompt' => 'You are a medical triage assistant. Assess urgency, ask one clarifying question at a time, and recommend next steps. Never diagnose.',
            ...
            'edges' => [
                ...
                ['id' => 'e-ai-msg', 'source' => 'openai-1', 'target' => 'message-3'],
                ['id' => 'e-triage-end', 'source' => 'message-3', 'target' => 'end-1'],
    ...
    'real_estate_agency_bot' => [
        ...
        'video_url' => null,
        'setup_hint' => 'Configure CRM API URL, property catalog, commercial WhatsApp Flow, OpenRouter key, and Hot Leads group.',
        'flow_data' => [
            'nodes' => [
                [
                    'id' => 'keyword_trigger-1',
                ...
                [
                    ...
                    'data' => [
                        ...
                        'settings' => [
                            'catalogId' => '',
                            'header' => 'Browse Available Rentals',
                            'displayMode' => 'link',
                        ],
                    ],
                ],
            ...
            'edges' => [
                ...
                ['id' => 'e-catalog-incoming', 'source' => 'whatsapp_catalog-1', 'target' => 'incomingMessage-1'],
                ['id' => 'e-incoming-branch', 'source' => 'incomingMessage-1', 'target' => 'branch-1'],
    ...
    'microfinance_banking_bot' => [
        ...
        'category' => 'banking',
        'video_url' => null,
        'setup_hint' => 'Configure core banking API, M-Pesa credentials, pre-approved loan offer template, Repayments group, and Active Repayers journey stage.',
        'flow_data' => [
            'nodes' => [
                [
                    'id' => 'keyword_trigger-1',
            ...
            'edges' => [
                ...
                ['id' => 'e-openai-msg', 'source' => 'openai-1', 'target' => 'message-3'],
    ...
    'hotel_tour_concierge_bot' => [
        ...
        'video_url' => null,
        'setup_hint' => 'Link suite and booking WhatsApp Flows, M-Pesa deposit settings, safari catalog, booking API, VIP Guests group, and confirmation template.',
        'flow_data' => [
            'nodes' => [
                [
                    'id' => 'keyword_trigger-1',
            ...
            'edges' => [
                ...
                ['id' => 'e-video-catalog', 'source' => 'video-1', 'target' => 'whatsapp_catalog-1'],
                ['id' => 'e-catalog-end', 'source' => 'whatsapp_catalog-1', 'target' => 'end-1'],
                ...
                ['id' => 'e-pricing-false-end', 'source' => 'check_pricing-1', 'target' => 'end-1', 'sourceHandle' => 'false'],
                ['id' => 'e-openai-msg', 'source' => 'openai-2', 'target' => 'message-1'],
                ['id' => 'e-itinerary-end', 'source' => 'message-1', 'target' => 'end-1'],
            ],
        ],
    ],
