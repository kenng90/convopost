...
<head>
    ...
    <title>Privacy Policy — {{ \Modules\Wpsupportlanding\Support\MauzoChatBrand::name() }}</title>
    <meta name="description" content="Privacy Policy for MauzoChat, the social commerce platform for WhatsApp.">
    ...
    <section class="relative pt-28 pb-16 noise hero-glow min-h-screen">
        <div class="relative z-10 max-w-3xl mx-auto px-4 sm:px-6">
            <div class="mb-10">
                ...
                <h1 class="font-display text-4xl sm:text-5xl font-800 mb-3 text-ink">Privacy Policy</h1>
            ...
            <div class="mt-12 pt-8 border-t border-indigo/10 flex flex-wrap gap-4">
                ...
                @if (Route::has('terms.show'))
                    <a href="{{ route('terms.show') }}" class="text-sm text-gray-600 hover:text-ink transition-colors">Terms of Service</a>
                @endif
                @if (Route::has('login'))
