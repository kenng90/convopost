...
namespace Modules\Whatsappcall\Providers;
...
class Main extends Provider
{
    ...
    {
        Blade::componentNamespace('Modules\Whatsappcall\View\Components', 'whatsappcall');
    }
    ...
    {
        $langPath = resource_path('lang/modules/whatsappcall');
