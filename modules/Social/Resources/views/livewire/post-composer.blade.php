        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                @if ($showNetworkOverrides)
                    ...
                    @foreach (['facebook' => 'Facebook', 'instagram' => 'Instagram', 'linkedin' => 'LinkedIn', 'tiktok' => 'TikTok', 'youtube' => 'YouTube', 'threads' => 'Threads', 'pinterest' => 'Pinterest', 'gbp' => 'Google Business', 'x' => 'X'] as $provider => $label)
